...
API_KEY = "FATi4-dMr_MWiduKBj1eymILBikSetLihhkVXS-Oqq4f"
...
def predict():
    ...
    if (dest == "ATL"):
        ...
        b = [0, 0, 0, 0, 1]
        inputs.extend(b)
    X = [[fl_num,month,dayofmonth,dayofweek,dayofweek,sdeptime,adeptime,arrtime,depdelay,a,b]]
    payload_scoring = {"input_data": [{"fields": [['fl_num','month','dayofmonth','dayofweek','sdeptime','adeptime','arrtime','depdelay','a','b']],
                                       "values": X}]}
    response_scoring = requests.post(
        'https://us-south.ml.cloud.ibm.com/ml/v4/deployments/7e936ea9-7e66-4c77-bfba-f29eb9a0c3f0/predictions?version=2022-11-25',
